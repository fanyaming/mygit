    ...
    <div id="container">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <s:if test="emp==null || emp.id==null">
                <tr>
                    <td class="ui_text_rt" width="140">密码</td>
                    <td class="ui_text_lt">
                        <s:password  name="emp.password"  class="ui_input_txt02"/>
                    </td>
                </tr>
                    <tr>
                        <td class="ui_text_rt" width="140">验证密码</td>
                        <td class="ui_text_lt">
                            <s:password  name="emp.repassword"  class="ui_input_txt02" />
                        </td>
                    </tr>
                </s:if>
                    <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#depts" name="emp.dept.id" listKey="id"
                        listValue="name"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:checkbox type="checkbox" name="emp.admin" class="ui_checkbox01"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#roles" name="" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 all_permissions"/>
                                </td>
                                <td align="center">
                                ...
                                <td>
                                    <s:select name="emp.roles.id" list="emp.roles" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 selected_permissions"/>
                                </td>
                            </tr>
                        </table>
                    </td>
